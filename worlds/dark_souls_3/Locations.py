...
location_tables: Dict[str, List[DS3LocationData]] = {
    ...
    "Firelink Shrine": [
        ...
        DS3LocationData("FS: Hollowslayer Greatsword - Ludleth for Greatwood",
                        "Hollowslayer Greatsword", missable=missable_transposition, conditional=True, boss=True, shop=True),
        ...
        DS3LocationData("FS: Wolf Knight's Greatsword - Ludleth for Abyss Watchers",
                        "Wolf Knight's Greatsword", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        ...
        DS3LocationData("FS: Old King's Great Hammer - Ludleth for Old Demon King",
                        "Old King's Great Hammer", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        ...
        DS3LocationData("FS: Greatsword of Judgment - Ludleth for Pontiff",
                        "Greatsword of Judgment", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        ...
        DS3LocationData("FS: Dancer's Enchanted Swords - Ludleth for Dancer",
                        "Dancer's Enchanted Swords", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        ...
        DS3LocationData("FS: Dragonslayer Greataxe - Ludleth for Dragonslayer",
                        "Dragonslayer Greataxe", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        DS3LocationData("FS: Dragonslayer Greatshield - Ludleth for Dragonslayer",
                        "Dragonslayer Greatshield", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
        ...
        DS3LocationData("FS: Dragonslayer Swordspear - Ludleth for Nameless",
                        "Dragonslayer Swordspear", missable=missable_transposition, conditional=True, boss=True,
                        shop=True),
    ...
    "Road of Sacrifices": [
        ...
        DS3LocationData("FS: Farron Dart - Orbeck", "Farron Dart",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_quest, npc=True,
                        shop=True),
        DS3LocationData("FS: Soul Arrow - Orbeck", "Soul Arrow",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_quest, npc=True,
                        shop=True),
        DS3LocationData("FS: Great Soul Arrow - Orbeck", "Great Soul Arrow",
                        missable=missable_quest, npc=True, shop=True),
        ...
        DS3LocationData("FS: Magic Shield - Orbeck", "Magic Shield",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_quest, npc=True,
                        shop=True),
        DS3LocationData("FS: Spook - Orbeck", "Spook", missable=missable_quest, npc=True,
                        shop=True),
        DS3LocationData("FS: Aural Decoy - Orbeck", "Aural Decoy", missable=missable_quest,
                        npc=True, shop=True),
        DS3LocationData("FS: Soul Greatsword - Orbeck", "Soul Greatsword",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_quest,
                        npc=True),
        DS3LocationData("FS: Farron Flashsword - Orbeck", "Farron Flashsword",
                        missable=missable_quest, npc=True, shop=True),
        ...
        DS3LocationData("FS: Homing Crystal Soulmass - Orbeck for Crystal Scroll",
                        "Homing Crystal Soulmass", missable=missable_quest, npc=True, shop=True),
        ...
        DS3LocationData("FS: Crystal Magic Weapon - Orbeck for Crystal Scroll",
                        "Crystal Magic Weapon", missable=missable_quest, npc=True, shop=True),
        DS3LocationData("FS: Cast Light - Orbeck for Golden Scroll", "Cast Light",
                        missable=missable_quest, npc=True, shop=True),
        DS3LocationData("FS: Twisted Wall of Light - Orbeck for Golden Scroll",
                        "Twisted Wall of Light", missable=missable_quest, npc=True, shop=True),
        ...
        DS3LocationData("FS: Hidden Body - Orbeck for Golden Scroll", "Hidden Body",
                        missable=missable_quest, npc=True, shop=True),
        DS3LocationData("FS: Repair - Orbeck for Golden Scroll", "Repair", missable=missable_quest,
                        npc=True, shop=True),
        ...
        DS3LocationData("FS: Young Dragon Ring - Orbeck for one scroll and buying three spells",
                        "Young Dragon Ring", missable=missable_quest, npc=True),
        DS3LocationData("FS: Slumbering Dragoncrest Ring - Orbeck for one scroll and buying seven spells",
                        "Slumbering Dragoncrest Ring", missable=missable_quest, npc=True),
